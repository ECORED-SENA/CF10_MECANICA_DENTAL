...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    div(style="margin-left: -3rem; margin-right: -3rem; min-width: calc(100% + 6rem); padding: 3rem; background: linear-gradient(0deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 34%, rgba(244,253,253,1) 54%, rgba(244,253,253,1) 92%, rgba(255,255,255,1) 100%);")
      ...
      img.d-none.d-md-flex(src='@/assets/curso/temas/tema4/img-2.svg')
      img.d-flex.d-md-none(src='@/assets/curso/temas/tema4/img-2-movil.svg')
    p.mb-5 El berilio, el magnesio, el calcio, el estroncio y el bario, llamados metales alcalinotérreos, son altamente electropositivos y constituyen el segundo grupo de elementos más reactivos. Su color es blanco con un lustre plateado y muy buenos conductores de electricidad.

    img.mb-5.d-none.d-md-flex(src='@/assets/curso/temas/tema4/img-3.svg')
    img.mb-5.d-flex.d-md-none(src='@/assets/curso/temas/tema4/img-3-movil.svg')

    p.mb-5 El escandio, titanio, vanadio, cromo, manganeso, hierro, cobalto, níquel, cobre, cinc, lantano, hafnio, tántalo, tungsteno, renio, osmio, iridio, platino, oro, mercurio, itrio, zirconio, niobio, molibdeno, tecnecio, rutenio, radio, paladio, plata, cadmio, actinio, son los llamados de transición. Son buenos conductores del calor y la electricidad, tienen altos puntos de fusión y de ebullición. El lantano, cerio, prasedonio, neodimio, prometio, samario, europio, gadolinio, terbio, disprosio. holmio, erbio, tulio, iterbio y lutecio, son los lantánidos, llamados también tierras raras, son blancos, plateados y muy reactivos. El aluminio, galio, indio y talio son metales blancos, blandos y con puntos de fusión relativamente bajos.

    img.mb-5.d-none.d-md-flex(src='@/assets/curso/temas/tema4/img-4.svg')
    img.mb-5.d-flex.d-md-none(src='@/assets/curso/temas/tema4/img-4-movil.svg')
    
    p.mb-5 Los elementos metálicos se pueden combinar entre sí y con otros elementos para formar compuestos, disoluciones y mezclas. Una mezcla de dos o más metales o de un metal y ciertos elementos no metálicos como el carbono, se denomina aleación.

    div(style="background: linear-gradient(0deg, rgba(255,255,255,1) 0%, rgba(231,249,250,1) 100%);")
      .p-4.col-xl-10.mx-auto
        p.mb-4 En el proceso y manipulación de los materiales dentales es muy importante tener presente las indicaciones de cada casa comercial, en cuanto a las fichas técnicas se trata, pues los productos que ofrecen tienen indicaciones diferentes de manejo de temperaturas, de proporciones para poder entregar un producto que cumpla con las especificidades necesarias como ejemplo de la información que se puede encontrar en una ficha técnica encontramos la siguiente:
        .d-flex.flex-wrap.align-items-center
          .col-lg-8
            img.mb-4.mb-lg-0(src='@/assets/curso/temas/tema4/img-5.jpg')
          .col-lg-4.ps-lg-4
            p #[b(style="color: #0273BC") ●] Composición.
              br
    ...
    p.mb-5 Permiten entender el comportamiento de un material sometido a la acción de fuerzas.
