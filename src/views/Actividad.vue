  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Características de la prótesis parcial removible
        p.mb-4 Identificar las características de la prótesis parcial removible para aplicarlas en la fabricación, teniendo en cuenta los protocolos de elaboración.
